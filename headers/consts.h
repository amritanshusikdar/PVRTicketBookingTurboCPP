...
static const char FILE__USER_LOGIN_DETAILS[13] = "userData.txt";
static const char FILE__MOVIES_DATABASE[11] = "movies.txt";
static const char FILE__SEATS_AVAILABLE[10] = "seats.txt";
